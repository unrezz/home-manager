  ...
  programs = {
    starship = {
      ...
      settings = {
        ...
        #   $os
        #   $username
        #   [](bg:color_m07 fg:color_m04)
        #   $directory
        #   [](fg:color_m07 bg:color_m02)
        #   $git_branch
        #   $git_status
        #   [](fg:color_m02 bg:color_m01)
        #   $c
        #   $cpp
        #   $rust
        #   $golang
